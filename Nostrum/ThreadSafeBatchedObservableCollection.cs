...
namespace Nostrum
{
    ...
    {
        private readonly _dispatcher _dispatcher;
    ...
    #region Constructors
        ...
        {
            _dispatcher = _dispatcher.CurrentDispatcher;
            _lock = new ReaderWriterLockSlim();
            BindingOperations.EnableCollectionSynchronization(this, _lock);
        }

        public TSObservableCollectionBatch(_dispatcher d)
        {
            _dispatcher = d ?? _dispatcher.CurrentDispatcher;
            _lock = new ReaderWriterLockSlim();
            BindingOperations.EnableCollectionSynchronization(this, _lock);
        }
